...
Mahedi = admin.create_account('Mahedi', 2000)

Hassan = admin.create_account('Hassan', 1000)

Mahedi.deposit(bank, 5000)

print(Mahedi.check_balance())
print(Hassan.check_balance())

Mahedi.withdraw(bank, 1000)
Mahedi.transfer(Hassan, 500)

admin.enable_loan_feature()

Mahedi.take_loan(bank, 1000)
...
transaction_history = Mahedi.get_transaction_history()
